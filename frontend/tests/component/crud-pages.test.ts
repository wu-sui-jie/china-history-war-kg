/** 四个知识库管理页的"能加载、能提交"悬挂用例（2026-09-25，S3-4）。
 *
 * 这四个页面此前零测试，而它们正是两轮改造的靶子：R1-1 修过它们的请求链路（vite 代理
 * 断链导致开发态全挂），FE-4 要把四份复制粘贴抽成组合式函数，P2-2 之后还要继续动它们。
 * 先钉住四条底线：
